        ...
        <ab:forEach var="jobPost" items="${jobPosts}">
            <div class="col mb-4">
                <div class="card border-dark bg-dark text-white">
                    ...
                    <a href="editJob?postId=${jobPost.postId}" class="btn btn-warning">Edit</a>
                    <button class="btn btn-danger" onclick="deleteJob(${jobPost.postId})">Delete</button>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
        ...
        <script>
        function deleteJob(postId) {
            if (confirm("Are you sure you want to delete this job post?")) {
                fetch("deleteJob?postId=" + postId, { method: "DELETE" })
                .then(response => {
                    if (response.ok) {
